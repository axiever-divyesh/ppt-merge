        ...
        <div class="form-container">
            ...
            <div class="file-detailss">
                <div class="file-details">
                    ...
                    <input type="text" class="merge-order-input" name="merge_order[]" id="merge_order_0"
                        value="1">

                    <label for="slide_numbers_0">Slide Numbers:</label>
                    <input type="text" class="slide-numbers-input" name="slide_numbers[0]" id="slide_numbers_0"
                        required>
        ...
        $(document).ready(function() {
            ...
            $("#merge-pdf-form").on('click', '.remove-field', function() {
                ...
                $('.file-details .pdf-file').each(function(index, element) {
                    $(this).attr('id', 'pdf-file_' + index).attr('name', 'pdf_file[' + index + ']')
                        .attr('id', 'pdf_file_' + index);
                    $(this).next("label").attr("id", 'pdf_file_' + index + '-error').attr("for",
                        'pdf_file_' + index);
                });
                $('.file-details .slide-numbers-input').each(function(index, element) {
                    $(this).attr('id', 'slide_numbers_' + index).attr('name', 'slide_numbers[' +
                        index + ']').attr('id', 'slide_numbers_' + index);
                    $(this).next("label").attr("id", 'slide_numbers_' + index + '-error').attr(
                        "for", 'slide_numbers_' + index);
                });
